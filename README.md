...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **LCOM001** | `LCOM_INCREASE` | Cohesion | Prohibits an increase in LCOM (degradation of cohesion) beyond the allowed delta. | `max_lcom_increase` | `ERROR` |
...
| **TCC001** | `TCC_INCREASE` | Cohesion | Prohibits a decrease in TCC (loss of cohesion) beyond the allowed delta. | `max_tcc_increase` | `UNKNOWN` |
| **TCC002** | `HIGH_TCC` | Cohesion | Limits the maximum absolute TCC value for a class. | `max_tcc` | `UNKNOWN` |
